...
window.Abilities = createReactClass({
    render: function () {
        return React.createElement(
            "div",
            { id: "ability" },
            React.createElement(Ability, { pl: this.props.pl })
        );
    }
});
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "div",
                            { id: "plHead" },
                            React.createElement("img", { src: "", alt: "Ruby" }),
                            " Ruby"
                        ),
                        React.createElement(
                            "div",
                            { "class": "progress" },
                            React.createElement("div", { "class": "progress-bar bg-success", role: "progressbar", "aria-valuenow": "25", "aria-valuemin": "0", "aria-valuemax": "100" })
                        ),
                        " ",
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "div",
                            { id: "plHead" },
                            React.createElement("img", { id: "pl", src: "https://cdn4.iconfinder.com/data/icons/stash/128/ruby-128.png", alt: "Ruby" }),
                            " Ruby"
                        ),
                        React.createElement(
                            "div",
...
window.Footer = createReactClass({
    render: function () {
        return React.createElement(
            "div",
            { id: "footer" },
            React.createElement(FootParagraph, null)
        );
    }
});
...
function FootParagraph() {
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
                "a",
                { href: "https://www.linkedin.com/in/ruirosillas/" },
                React.createElement("img", { width: "20px", src: 'https://cdn1.iconfinder.com/data/icons/logotypes/32/square-linkedin-128.png', alt: "LinkedIn" }),
                " Rui Rafael Rosillas"
            ),
            "     ",
            React.createElement(
                "a",
                { href: "mailto:ruirosillas@gmail.com?Subject=Hi%20PortfolioWebsite" },
                React.createElement("img", { width: "20px", src: 'https://cdn2.iconfinder.com/data/icons/circle-icons-1/64/mail-128.png', alt: "Mail" }),
        ...
        React.createElement(
            ...
            null,
            "Powered By ",
            React.createElement("img", { width: "20px", src: 'https://thinkster.io/assets/homepage/rails-9b13de39de9d2eed10a2418734ee1e584cdc9634c04206af1c2bfcc8b0d0e3d5.png', alt: "Ruby" }),
            React.createElement("img", { width: "40px", src: 'https://sites.udel.edu/enesavc/files/2017/10/1-1hh3nl3.png', alt: "GitHub" }),
            React.createElement("img", { width: "40px", src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/React-icon.svg/1200px-React-icon.svg.png', alt: "ReactJS" }),
            React.createElement("img", { width: "40px", src: 'https://softwareengineeringdaily.com/wp-content/uploads/2016/10/herokukafka.png', alt: "Heroku" })
        )
    );
};
...
function Logo(props) {
  return React.createElement(
    "h1",
    null,
    React.createElement("img", { id: "logo", src: props.logo_pic })
  );
}

function MyPic(props) {
  return React.createElement("img", { id: "mypic", src: props.front_pic });
}
...
function Paragraph() {
  return React.createElement(
    "p",
    null,
    "Hi, I'm Rui, I'm a Software Engineer based in Vancouver, British Columbia, Canada, who has worked with different Technologies Ranging from Web and Mobile Development, Desktop Application, and Software Testing."
  );
}
...
window.Frontpage = createReactClass({
  render: function () {
    return React.createElement(
      "div",
      null,
      React.createElement("div", { id: "bg-page" }),
      React.createElement(
        "div",
        { id: "front-page" },
        React.createElement(Logo, { logo_pic: this.props.logo_pic }),
        React.createElement(MyPic, { front_pic: this.props.front_pic }),
        React.createElement(Paragraph, null),
        React.createElement(IndexButton, null)
      )
    );
  }
});
window.IndexBody = createReactClass({
  render: function () {
    return React.createElement(
      "div",
      { "class": "grid-container", id: "AboutBody" },
      React.createElement(AboutMe, null),
      React.createElement(Skills, { p: this.props.skill_pic })
    );
  }
});
...
function AboutMe() {
  return React.createElement(
    "div",
    { "class": "grid-item", id: "summary" },
    "Summary",
    React.createElement(
      "p",
      null,
      " ❝ A strong and passionate individual with a background in Computer Science focusing the field of Software Development and Software Quality Assurance. A hands-on individual tackling different sets of technologies involving Mobile Android Application, Backend Web Development Application, Desktop Application Development, and Automation Application. ❠"
    )
  );
}

function SkillDiv(p) {
  return React.createElement("img", { id: "imgSkill", src: p.p[1], alt: p.p[2] });
}

function Skills(props) {
  return React.createElement(
    "div",
    { "class": "grid-item", id: "plskills" },
    React.createElement(
      "div",
      { id: "skillcarousel", "class": "carousel slide", "data-ride": "carousel" },
      React.createElement(
        "div",
        ...
        React.createElement(
          ...
          React.createElement(SkillDiv, { p: ['Datablues', props.p[0], "First Slide"] })
        ),
        React.createElement(
          "div",
          { "class": "carousel-item" },
          React.createElement(SkillDiv, { p: ['MFeeds', props.p[1], "Second Slide"] })
        ),
        React.createElement(
          "div",
          { "class": "carousel-item" },
          React.createElement(SkillDiv, { p: ['SimpleBot', props.p[2], "Third Slide"] })
        ),
        React.createElement(
          "div",
          { "class": "carousel-item" },
          React.createElement(SkillDiv, { p: ['Java Weight Balancer', props.p[3], "Fourth Slide"] })
        )
      )
    )
  );
...
window.Navbar = createReactClass({
  render: function () {
    return React.createElement(
      "div",
      null,
      React.createElement("div", { id: "bg-index" }),
      React.createElement(Slider, { slider_pic: this.props.slider_pic }),
      React.createElement(MyPic2, { p: this.props.my_pic }),
...
function Nav() {
  return React.createElement(
    "nav",
    { "class": "navbar navbar-expand-md  navbar-light bg-faded main-nav" },
    React.createElement(
      "button",
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "a",
            { "class": "nav-link", href: "/work" },
            "Work"
          )
        ),
        React.createElement(
          "li",
          { "class": "nav-item", id: "right" },
          React.createElement(
            "a",
            { "class": "nav-link", href: "#" },
            "Blog"
...
function MyPic2(p) {
  return React.createElement(
    "div",
    { id: "mypic" },
    React.createElement("img", { id: "mypic", src: p.p[0], alt: "mypic" }),
    React.createElement("br", null),
    React.createElement(
      "i",
      { id: "mypic" },
      ...
      React.createElement(
        ...
        React.createElement(
          "a",
          { href: "https://github.com/rui725" },
          React.createElement("img", { id: "footer", src: p.p[3], alt: "GitHubLink" })
        ),
        "   ",
        React.createElement(
          "a",
          { href: "https://www.linkedin.com/in/ruirosillas/" },
          React.createElement("img", { id: "footer", src: p.p[1], alt: "LinkedInLink" })
        ),
        "  ",
        React.createElement(
          "a",
          { href: "mailto:ruirosillas@gmail.com?Subject=Hi%20PortfolioWebsite" },
          React.createElement("img", { id: "footer", src: p.p[2], alt: "EmailLink" })
        ),
        "  ",
        React.createElement(
          "a",
          { href: "" },
          React.createElement("img", { id: "footer", src: p.p[4], alt: "ResumeLink" })
        ),
        " "
      )
    )
...
function Divider(p) {
  return React.createElement(
    ...
    React.createElement("img", { id: "imgCar", src: p.p[1], alt: p.p[2] })
  );
}
...
function Slider(props) {
  return React.createElement(
    "div",
    { id: "navcarousel", "class": "carousel slide", "data-ride": "carousel" },
    React.createElement(
      "div",
      { "class": "carousel-inner" },
      React.createElement(
        "div",
        { "class": "carousel-item active" },
        React.createElement(Divider, { p: ['Mobile Development in Android Platform', props.slider_pic[0], "First Slide"] })
      ),
      React.createElement(
        "div",
        { "class": "carousel-item" },
        React.createElement(Divider, { p: ['Desktop Application Development', props.slider_pic[1], "Second Slide"] })
      ),
      React.createElement(
        "div",
        { "class": "carousel-item" },
        React.createElement(Divider, { p: ['Backend Web Application Development', props.slider_pic[2], "Third Slide"] })
      ),
      React.createElement(
        "div",
        { "class": "carousel-item" },
        React.createElement(Divider, { p: ['Software Quality Assurance', props.slider_pic[3], "Fourth Slide"] })
      )
    )
  );
};
